...
namespace Binary_Signal {
	...
	public:
		...
		Binary_Signal (int bin_level, const char signal_duration[MAX_DURATION]);
		...
		void GetSignal (Signal_Parameter& a, int bin_level, const char str[MAX_DURATION]) const; //получить определенный сигнал
		...
		void DeleteSignal (int time, const char* signal_duration);
